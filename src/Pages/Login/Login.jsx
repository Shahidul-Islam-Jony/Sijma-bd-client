                ...
                <div className={`wrapper ${isClicked ? 'active' : ''}`}>
                    ...
                    <div>
                        <div className="form-box login ">
                            ...
                            <form onSubmit={handleLogin} action="#">
                                ...
                                <div className="animation flex gap-2 mt-4" style={{ '--i': 5, '--j': 26 }}>
                                    <button className="hover:bg-blue-800 hover:text-white flex items-center gap-2 border-2 border-blue-500 px-4 py-1 rounded-md font-medium"><FcGoogle /> Google</button>
                                    <button className="hover:bg-blue-800 hover:text-white flex items-center gap-2 border-2 border-blue-500 px-4 py-1 rounded-md font-medium"><FaFacebook /> Facebook</button>
                                </div>

                                <div className="logreg-link animation" style={{ '--i': 6, '--j': 27 }}>
                                    <p>Do not have an account? <a href="#" onClick={() => setIsClicked(true)} className="register-link text-white hover:text-gray-400 md:text-blue-500 md:hover:text-blue-800">Sign Up</a></p>
                                </div>
                            </form>
                        </div>
                        ...
                        <div className="info-text login">
                            ...
                            <p className="animation" style={{ '--i': 1, '--j': 21 }}>Sijma is always with your side.</p>
                        </div>
                    </div>
                    {/* Registration part */}
