    ...
    <div>
          ...
          <div className="animation upload" style={{ "--i": 20, "--j": 3 }}>
            <span className="flex items-center hover:text-blue-500">
              <input
                ...
                className="relative z-10 h-10 opacity-0"
                required
              />
              <label className="absolute  border-2 border-t-0 border-x-0 top-0 h-10 border-b-blue-500 w-full text-black text-nowrap overflow-hidden">
                {imageUrl ? imageUrl : "Upload Your Photo"}
              </label>
          ...
          >
            <p>
              ...
              <a
                ...
                className="login-link text-blue-500 hover:text-blue-800"
              >
                Login
              </a>
            </p>
      ...
      <div className="info-text register">
        ...
        <p className="animation" style={{ "--i": 18, "--j": 1 }}>
          Sign Up for getting full support of Sijma.
        </p>
      </div>
